...
export default function products() {
  return (
    <div className="min-h-screen bg-solid">
        ...
        products
        <div className="flex">
            <a href="" className=""><h2>Documentation</h2></a>
        </div>
        <div class="max-w-xs rounded overflow-hidden shadow-lg">
  <Image className="w-full" src={turbo} alt="Sunset in the mountains"/>
  <div class="px-6 py-4">
  ...
  <div class="max-w-2xl mx-auto">
	...
	<div class="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
		<a href="#">
			<Image class="rounded-t-lg p-8" src="https://flowbite.com/docs/images/products/product-1.png" alt="product image"/>
        </a>
			<div class="px-5 pb-5">
				<a href="#">
